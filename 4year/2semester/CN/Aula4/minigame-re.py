...
class Agent:
    ...
    def __init__(self, start=8, end=3, end_negative=7, lr=0.7, gamma=0.96, exp_rate=0.3, epsilon=0.3, e_degradation=0.03):
        ...
        self.allrewards = []
        self.end = end
        self.end_negative = end_negative
        ...
        self.reward = np.array([[Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (0,0) - State 0
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (0,1) - State 1
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Goal_reward],                       # position (0,2) - State 2
                   [Penalizer_movement, Penalizer_reward, Penalizer_movement, Penalizer_movement],                  # position (0,3) - State 3
                   
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (1,0) - State 4
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (1,1) - State 5
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_reward],                  # position (1,2) - State 6
                   [Goal_reward, Penalizer_movement, Penalizer_movement, Penalizer_movement],                       # position (1,3) - State 7
                   
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (2,0) - State 8
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (2,1) - State 9
                   [Penalizer_movement, Penalizer_movement, Penalizer_movement, Penalizer_movement],                # position (2,2) - State 10
                   [Penalizer_reward, Penalizer_movement, Penalizer_movement, Penalizer_movement]])                 # position (2,3) - State 11
    ...
    def play_q_learning(self, rounds=25):
        for _ in range(rounds):
            self.path = []
            round_reward = 0
            self.state = self.start
            while self.state != self.end and self.state != self.end_negative:
                Qx = -999
