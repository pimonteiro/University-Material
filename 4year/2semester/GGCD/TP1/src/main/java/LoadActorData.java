...
public class LoadActorData {
    ...
    public static void load_actors_data() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(LoadActorData.class);
